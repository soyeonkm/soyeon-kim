...
window.addEventListener('load', () => {
    ...
    if (codeWindow) {
        setTimeout(() => codeWindow.style.opacity = '1', 1200);
    }
});
...
style.textContent = `
    .hero-title, .hero-description, .hero-buttons, .code-window {
        opacity: 0;
        transition: opacity 0.8s ease;
    }
    
    .project-card, .skill-item, .timeline-item {
        opacity: 0;
        transform: translateY(30px);
        transition: all 0.6s ease;
    }
    
    .project-card.animate-in, .skill-item.animate-in, .timeline-item.animate-in {
        opacity: 1;
